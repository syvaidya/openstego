...
public class ExtractPanel extends JPanel
{
    ...
    private void initialize()
    {
        ...
        add(new JLabel(labelUtil.getString("gui.label.inputStegoFile")), gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 0.0;
        add(new JLabel(labelUtil.getString("gui.label.outputDataFolder")), gridBagConstraints);
