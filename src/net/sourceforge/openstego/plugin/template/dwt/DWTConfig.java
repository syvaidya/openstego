...
/**
 * Class to store configuration data for DWT plugin template
 */
public class DWTConfig extends OpenStegoConfig
{
    /**
    ...
    /**
     * Constructor with map of configuration data. Please make sure that only valid keys for configuration items are
     * provided, and the values for those items are also valid.
     * 
     * @param propMap Map containing the configuration data
     * @throws OpenStegoException
     */
    public DWTConfig(Map propMap) throws OpenStegoException
    {
     ...
     * @throws OpenStegoException
     */
    public DWTConfig(CmdLineOptions options) throws OpenStegoException
    {
        super(options);
    }
